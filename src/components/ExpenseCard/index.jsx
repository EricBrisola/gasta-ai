...
const ExpenseCard = ({
  ...
  return (
    <article
      key={id}
      className="flex max-h-52 min-h-48 min-w-48 max-w-[14.55rem] flex-col items-center justify-between rounded-md bg-[#F7F6FA] text-white shadow-md duration-200 hover:scale-105"
    >
