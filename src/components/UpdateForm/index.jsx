...
const EditForm = ({
  ...
  return (
    <form className="flex flex-col gap-6 py-1 text-black max-[430px]:items-center">
      <section className="flex flex-row flex-wrap gap-4 max-[430px]:justify-center">
      ...
      <button
        className="rounded-md bg-[#645cff] p-2 text-white shadow-sm shadow-[#645cff]/20 duration-200 hover:shadow-lg hover:shadow-[#645cff]/40 max-[430px]:w-56"
